...
task_name = "ins_seg" # "drivable", "sem_seg", "ins_seg"
config_file = "/home/zekun/drivable/src/models/ins_seg/mask_rcnn_config.py"
checkpoint_file = "/home/zekun/drivable/outputs/ins_seg/test/mask_rcnn_r50_fpn_3x_32bs_ins_seg_bdd100k.pth"
new_checkpoint_file = "/home/zekun/drivable/outputs/ins_seg/test/mask_rcnn_new.pth"
...
model = BDD100kModel(backbone=tools.load_mmcv_checkpoint2(config_file, checkpoint_file))
